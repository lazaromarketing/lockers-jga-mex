...
export default function WhatsAppFloat() {
  ...
  // Ocultar después de 5 segundos si no se interactúa
  useEffect(() => {
    if (mounted && !isOpen) {
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-50">
        {/* Menú desplegable */}
        {isOpen && (
          <div className="absolute bottom-20 right-0 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 animate-[fadeIn_0.3s_ease-out]">
            {/* Header del menú */}
        ...
        <div className="relative">
          {isVisible && !isOpen && (
            <div className="absolute -top-12 right-0 bg-white px-3 py-2 rounded-lg shadow-lg border border-gray-200 animate-[fadeIn_0.3s_ease-out]">
              <div className="flex items-center">
